...
export const metadata = {
  ...
  description:
    "Venta de pan integral, prepizzas de masa madre y waffles de almendras. Productos naturales, sin conservantes y llenos de sabor. ¡Hace tu pedido online!",
  keywords: [
    "pan integral artesanal",
    "waffles de almendras",
